        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <div className="flex flex-col md:flex-row gap-2 mt-6">
              ...
              <button className=" w-full  text-[12px] sm:text-sm md:text-md flex items-center justify-center px-3 sm:px-4 md:px-6 py-2  md:py-2.5 bg-success  text-white  font-semibold cursor-pointer   hover:bg-green-700 gap-2 ">
                Buy Now
              </button>
            </div>
          </div>
